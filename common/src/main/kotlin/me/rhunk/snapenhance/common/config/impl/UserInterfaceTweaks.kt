...
class UserInterfaceTweaks : ConfigContainer() {
    ...
    inner class CustomizeUi : ConfigContainer(hasGlobalState = true) {
        ...
        val backgroundColoursurface = string("background_colour_surface") { addNotices(FeatureNotice.UNSTABLE, FeatureNotice.BAN_RISK, FeatureNotice.INTERNAL_BEHAVIOR); requireRestart()}
